...
class Cases extends ModelBase
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('description, solving', 'length', 'max'=>128),
			array('case_date, create_time, update_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, case_date, description, solving, mesin_id, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tblIssues' => array(self::MANY_MANY, 'Issue', 'tbl_cabang_user_assignment(cabang_id, user_id)'),
	...
	public function search()
	{
		...
		$criteria->compare('case_date',$this->case_date,true);
